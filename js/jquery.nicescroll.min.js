    ...
    var z = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        M = function() {
            ...
            a: { h = ["-moz-grab", "-webkit-grab", "grab"]; if (b.ischrome && !b.ischrome22 || b.isie) h = []; for (k = 0; k < h.length; k++)
                    ...
                    h = "url(http://www.google.com/intl/en_ALL/mapfiles/openhand.cur),n-resize" } b.cursorgrabvalue =
                h;
        ...
        N = function(g, b) {
                    ...
                    if (d.isie9mobile) a.scrollmom = new H(a), a.onmangotouch = function(c) {
                                ...
                                if (!a.locked) {
                                    if (d.hasmstouch)
                                        for (var b =
                                            ...
                                            b = b.parentNode ? b.parentNode : !1 } a.cancelScroll();
                                ...
                                function(c, b) {
                                    ...
                                    if (a.rail.drag && 2 == a.rail.drag.pt) {
                                        ...
                                        if (a.rail.drag.dl) f = !0, "v" == a.rail.drag.dl ? l = a.rail.drag.sl : "h" == a.rail.drag.dl && (g = a.rail.drag.st);
                                                ...
                                                n > m && (a.rail.drag.dl = "f", e("body").scrollLeft(e("body").scrollLeft())) } } a.synched("touchmove",
                        ...
                        if (d.cantouch || a.opt.touchbehavior) a.onpreventclick = function(c) { if (a.preventclick) return a.preventclick.tg.onclick = a.preventclick.click, a.preventclick = !1, a.cancelEvent(c) }, a.bind(a.win, "mousedown", a.ontouchstart), a.onclick = d.isios ? !1 : function(c) {
                            ...
                            var p = function(c) { if (a.selectiondrag) { if (c) { var b = a.win.outerHeight();
                                        ...
                                        0 < c && c < b && (c = 0);
                                        c >= b && (c -= b);
                                        a.selectiondrag.df = c } 0 != a.selectiondrag.df && (a.doScrollBy(2 * -Math.floor(a.selectiondrag.df / 6)), a.debounced("doselectionscroll", function() { p() }, 50)) } };
            ...
            this.onResize = function(c, b) {
                ...
                if (a.page.maxh == f && a.page.maxw == d && a.view.w == e) { if (a.ispage) return a;
                    ...
                    a.lastposition = f } 0 == a.page.maxh ? (a.hideRail(), a.scrollvaluemax = 0, a.scroll.y = 0, a.scrollratio.y = 0, a.cursorheight = 0, a.setScrollTop(0), a.rail.scrollable = !1) : a.rail.scrollable = !0;
            ...
            this.remove = function() {
                ...
                for (var c = 0; c < a.saved.css.length; c++) { var b = a.saved.css[c];
                    b[0].css(b[1], "undefined" == typeof b[2] ? "" : b[2]) } a.saved = !1;
            ...
            this.doScrollBy = function(b, d) {
                ...
                if (a.bouncescroll) { var e = Math.round(a.view.h / 2);
                    f < -e ? f = -e : f > a.page.maxh + e && (f = a.page.maxh + e) } a.cursorfreezed = !1;
                py = a.getScrollTop(!0);
            ...
            this.doScrollLeftBy = function(b, d) { var f = 0,
                    ...
                    f < -e ? f = -e : f > a.page.maxw + e && (f = a.page.maxw + e) } a.cursorfreezed = !1;
            ...
            this.doZoomIn = function(b) {
                if (!a.zoomactive) {
                    ...
                    for (g in h) { var k = h[g];
                        a.zoomrestore.style[k] = "undefined" != typeof f[k] ? f[k] : "" } a.zoomrestore.style.width = a.win.css("width");
